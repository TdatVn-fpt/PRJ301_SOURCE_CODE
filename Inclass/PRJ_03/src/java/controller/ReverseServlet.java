    ...
    throws ServletException, IOException {
     ...
     String result = "";
        ...
        if("reverse".equals(action)) {
            result = new StringBuilder(input1).reverse().toString();
        }else if("uppercase".equals(action)){
            result = input1.toUpperCase();
        } else if("lowercase".equals(action)){
            result = input1.toLowerCase();
        }
        response.setContentType("text/html");
         response.getWriter().println("<h2>Your name enter = " + input1 + "</h2>");
